...
import nandhethapic from '../images/nanthetha.jpg';
      ...
      <section className="py-16 px-6 bg-white">
        <div className="max-w-6xl mx-auto text-center">
          ...
          <div className="flex flex-wrap justify-center gap-8">
            <a href="mailto:22csec16@gmail.com" className="flex items-center gap-3 text-gray-700 hover:text-blue-600 transition-colors">
              <Mail className="w-6 h-6" />
              <span>22csec16@gmail.com</span>
            </a>
            <a href="tel:9629800878" className="flex items-center gap-3 text-gray-700 hover:text-blue-600 transition-colors">
              <Phone className="w-6 h-6" />
              <span>9629800878</span>
            </a>
            <a href="https://www.linkedin.com/in/nanthetha-sri-cs-07608428b/" target="_blank" rel="noopener noreferrer" className="flex items-center gap-3 text-gray-700 hover:text-blue-600 transition-colors">
          ...
          <div className="mt-12">
            <button 
              onClick={() => window.open('https://drive.google.com/file/d/1eQ2nvV7BM9EHigIjhN4cYfGTSHgDuCvS/view?usp=sharing', '_blank')}
