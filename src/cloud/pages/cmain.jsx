...
import nantheha from '../images/nanthetha.jpg';
import amruthan from '../images/amrudan.jpg';
...
const Cloud= () => {
  ...
  const trainers = [
    ...
    {
        url: '/swathi',
        img: swathi,  // Using the imported image
        name: 'SWATHI N D',
        role: 'CLOUD ENGINEER',
        expertise: ['AWS', 'Node.js', 'reactjs'],
      
    },
 
    {
        url: '/nanthetha',
        img: nantheha,  // Using the imported image
        name: 'NANTHETHA SRI',
        role: 'CLOUD ENGINEER',
        expertise: ['AWS', 'Node.js', 'reactjs'],
    ...
    { 
      url: '/amrudan',
      img: amruthan,  // Using the imported image
      name: 'AMRUDAN T S S',
      role: 'CLOUD ENGINEEER',
      expertise: ['AWS', 'Node.js', 'reactjs','JAVA'],
        ...
        <div className="container mx-auto px-6 relative z-10">
          <div className="flex flex-col items-center text-center">
            ...
            <p className="text-xl md:text-2xl text-blue-700 mb-12 max-w-2xl leading-relaxed">
              Master the complete CLOUD COMPUTING with our Trainers
            </p>

            <div className="flex flex-wrap gap-6 justify-center">
              <button className="px-8 py-4 bg-gradient-to-r from-blue-500 to-blue-700 rounded-full font-semibold text-white hover:from-blue-600 hover:to-blue-800 transition-all hover:scale-105 active:scale-95 shadow-lg shadow-blue-200" onClick={()=>navigate('/Cloudgmeet')}>
                Start Your Journey
              </button>
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-12">
            ...
            <div>
              ...
              <div className="flex gap-6">
                <a href="principal@vcet.ac.in" className="text-gray-600 hover:text-blue-600 transition">
                  <Mail className="w-6 h-6" />
                </a>
                <a href="https://www.facebook.com/vcetmadurai/" className="text-gray-600 hover:text-blue-600 transition">
                  <Facebook className="w-6 h-6" />
                </a>
                <a href="https://www.linkedin.com/school/velammal-college-of-engineering-&-technology-madurai/" className="text-gray-600 hover:text-blue-600 transition">
                  <Linkedin className="w-6 h-6" />
                </a>
                <a href="https://vcet.ac.in/" className="text-gray-600 hover:text-blue-600 transition">
