...
const Harini  = () => {
  ...
  const experiences = [
    {
      company: "Tringapps ,Chennai",
      role: "Full Stack Developer",
      // duration: "2020 - Present",
      responsibilities: [
        "Tech stack:React js,Node js,Express js Tailwind,Postman API,Swagger,github(basics)",
        "Built a scalable and efficient portal to store and retrieve intern details, facilitating easy identification for recruitment.",
    ...
    },
    {
      ...
      responsibilities: [
        ...
        "Developed a mini game with help of unreal Engine(UE5)Blueprint visual scripting for rapid prototyping and iterative designs",
        "Technologies:Blueprints,3D objects,UE5"
      ]
    }
  ];
        ...
        <div className="max-w-6xl mx-auto px-6">
          <div className="flex flex-col md:flex-row items-center gap-12">
            ...
            <div className="text-center md:text-left">
              ...
              <h2 className="text-2xl text-blue-600 mb-4">Full Stack Developer Trainerr</h2>
              <p className="text-xl text-gray-700 max-w-2xl">
                Passionate full stack developer with building scalable web applications.
              </p>
            </div>
          </div>
        </div>
      ...
      <section className="py-16 px-6 bg-white">
        <div className="max-w-6xl mx-auto text-center">
          ...
          <div className="flex flex-wrap justify-center gap-8">
            <a href="mailto:22csec09@gmail.com" className="flex items-center gap-3 text-gray-700 hover:text-blue-600 transition-colors">
              <Mail className="w-6 h-6" />
              <span>22csec09@gmail.com</span>
            </a>
            <a href="tel:9688396146" className="flex items-center gap-3 text-gray-700 hover:text-blue-600 transition-colors">
              <Phone className="w-6 h-6" />
              <span>+9688396146</span>
            </a>
            <a href="https://www.linkedin.com/in/harini-s-107179291" target="_blank" rel="noopener noreferrer" className="flex items-center gap-3 text-gray-700 hover:text-blue-600 transition-colors">
          ...
          <div className="mt-12">
            <button 
              onClick={() => window.open('https://drive.google.com/file/d/19SeG9gJMK0u4oLQEIoEKCfp-Xhqxksd0/view?usp=sharing', '_blank')}
