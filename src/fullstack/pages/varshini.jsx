        ...
        <div className="max-w-6xl mx-auto px-6">
          <div className="flex flex-col md:flex-row items-center gap-12">
            ...
            <div className="text-center md:text-left">
              ...
              SECOND YEAR UG STUDENT AT VELAMMAL COLLEGE OF ENGINEERING ANDTECHNOLOGY
              EXPERTISE IN FULL STACK , UI DESIGN
              </p>
            </div>
          </div>
        </div>
      ...
      <section className="py-16 px-6 bg-white">
        <div className="max-w-6xl mx-auto text-center">
          ...
          <div className="flex flex-wrap justify-center gap-8">
            <a href="mailto:varshiniprabakaran0506@gmail.com" className="flex items-center gap-3 text-gray-700 hover:text-blue-600 transition-colors">
              <Mail className="w-6 h-6" />
              <span>varshiniprabakaran0506@gmail.com</span>
            </a>
            <a href="tel:+91 9150791543" className="flex items-center gap-3 text-gray-700 hover:text-blue-600 transition-colors">
              <Phone className="w-6 h-6" />
              <span>+91 9150791543</span>
            </a>
            <a href="https://www.linkedin.com/in/varshini-prabakaran-0a503a2aa/" target="_blank" rel="noopener noreferrer" className="flex items-center gap-3 text-gray-700 hover:text-blue-600 transition-colors">
          ...
          <div className="mt-12">
            <button 
              onClick={() => window.open('https://drive.google.com/file/d/1ceKSuzHXk-UgMQSA82Jb7AqHB4qp8Ljd/view?usp=sharing', '_blank')}
