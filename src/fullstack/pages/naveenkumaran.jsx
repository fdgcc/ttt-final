  ...
  const experiences = [
    {
      ...
      responsibilities: [
        'Skills Gained: React, Node.js, MongoDB, Express, Tailwind, API Development, Web hosting, Team Collaboration, AGILE Workflow.'
      ]
    },
    {
      ...
      responsibilities: [
        ...
        'Sills Gained: HTML, CSS, JS, Tailwind, API (Open Weather)'
      ]
    }
  ];
      ...
      <section className="py-16 px-6 bg-white">
        <div className="max-w-6xl mx-auto text-center">
          ...
          <div className="flex flex-wrap justify-center gap-8">
            <a href="mailto:navinkumaran2004@gmail.com" className="flex items-center gap-3 text-gray-700 hover:text-blue-600 transition-colors">
              <Mail className="w-6 h-6" />
              <span>navinkumaran2004@gmail.com</span>
            </a>
            <a href="tel:+91 86107039700" className="flex items-center gap-3 text-gray-700 hover:text-blue-600 transition-colors">
              <Phone className="w-6 h-6" />
              <span>+91 8610703970</span>
            </a>
            <a href="https://www.linkedin.com/in/navin2004/" target="_blank" rel="noopener noreferrer" className="flex items-center gap-3 text-gray-700 hover:text-blue-600 transition-colors">
          ...
          <div className="mt-12">
            <button 
              onClick={() => window.open('https://drive.google.com/drive/folders/1gE42koszYPHbmGAk1IvZ6CJ5RlVXevCb', '_blank')}
