...
const Minojini = () => {
  ...
  const skills = [
    ...
    "TypeScript", "TAILWIND", "UIUX", "PYTUBE TKINTER"
  ];
        ...
        <div className="max-w-6xl mx-auto px-6">
          <div className="flex flex-col md:flex-row items-center gap-12">
            ...
            <div className="text-center md:text-left">
              ...
              UG STUDENT AT VELAMMAL COLLEGE OF ENGINEERING AND TECHNOLOGY Madurai, Tamilnadu , India
              EXPERTISE AT FULL STACK DEVELOPMENT ,UI UX DESIGNING
              </p>
            </div>
          </div>
        </div>
      ...
      <section className="py-16 px-6 bg-white">
        <div className="max-w-6xl mx-auto text-center">
          ...
          <div className="flex flex-wrap justify-center gap-8">
            <a href="mailto:minojini05@gmail.com" className="flex items-center gap-3 text-gray-700 hover:text-blue-600 transition-colors">
              <Mail className="w-6 h-6" />
              <span>minojini05@gmail.com</span>
            </a>
            <a href="tel:70924 70579" className="flex items-center gap-3 text-gray-700 hover:text-blue-600 transition-colors">
              <Phone className="w-6 h-6" />
              <span>7092470579</span>
            </a>
            <a href="https://www.linkedin.com/in/minojini-g/" target="_blank" rel="noopener noreferrer" className="flex items-center gap-3 text-gray-700 hover:text-blue-600 transition-colors">
          ...
          <div className="mt-12">
            <button 
              onClick={() => window.open('https://drive.google.com/file/d/1PZ7ZYihweRK7Y-b9RMg5h_F7Pej25b4O/view?usp=sharing', '_blank')}
