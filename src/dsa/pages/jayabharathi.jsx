...
const Jayabharathi = () => {
  ...
  const experiences = [
    {
      company: "Ayelet Studio Pvt., Ltd., Chennai— Intern",
      role: "game developmer",
      duration: "DEC 2023 - JAN 2024",
      responsibilities: [
        "Gained a new experience and learnt the basics of game development using unreal engine"
      ]
    },
    {
      company: "Tringapps Pvt., Ltd., Chennai— Intern",
      role: "Full-stack developer",
      duration: "01.07.2024 to 30.07.2024",
      responsibilities: [
       'Worked on a real time full stack project',
      ]
      ...
      <section className="py-16 px-6 bg-white">
        <div className="max-w-6xl mx-auto text-center">
          ...
          <div className="flex flex-wrap justify-center gap-8">
            <a href="mailto:22csec11@gmail.com" className="flex items-center gap-3 text-gray-700 hover:text-blue-600 transition-colors">
              <Mail className="w-6 h-6" />
              <span>22csec11@gmail.com</span>
            </a>
            <a href="tel:6379406506" className="flex items-center gap-3 text-gray-700 hover:text-blue-600 transition-colors">
              <Phone className="w-6 h-6" />
              <span>6379406506</span>
            </a>
            <a href='https://www.linkedin.com/in/jayabharathi-prabhakaran-777395292/' target="_blank" rel="noopener noreferrer" className="flex items-center gap-3 text-gray-700 hover:text-blue-600 transition-colors">
          ...
          <div className="mt-12">
            <button 
              onClick={() => window.open('https://drive.google.com/file/d/1aOZrMJ2k1QDRwqNgBhN2C-tBIyefEaRK/view?usp=sharing', '_blank')}
