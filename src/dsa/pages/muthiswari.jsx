...
const Muthis = () => {
  ...
  const experiences = [
    {
      company: "Svasti Technology-Frontend",
    ...
    {
      company: "VCET (In-house project)",
      role: "Full-stack developer",
      duration: "01.07.2024 to 30.07.2024",
      responsibilities: [
       ' College Inhouse project at VCET(building Website for College)',
      ]
      ...
      <section className="py-16 px-6 bg-white">
        <div className="max-w-6xl mx-auto text-center">
          ...
          <div className="flex flex-wrap justify-center gap-8">
            <a href="mailto:22csec15@gmail.com" className="flex items-center gap-3 text-gray-700 hover:text-blue-600 transition-colors">
              <Mail className="w-6 h-6" />
              <span>22csec15@gmail.com</span>
            </a>
            <a href="tel:9384184835" className="flex items-center gap-3 text-gray-700 hover:text-blue-600 transition-colors">
              <Phone className="w-6 h-6" />
              <span>9384184835</span>
            </a>
            <a href='https://www.linkedin.com/in/muthieswari-saravanan-4b6606290/' target="_blank" rel="noopener noreferrer" className="flex items-center gap-3 text-gray-700 hover:text-blue-600 transition-colors">
          ...
          <div className="mt-12">
            <button 
              onClick={() => window.open('https://drive.google.com/file/d/1_mDox95bhGL6VRemLHZbyA79jyn8Sn8A/view?usp=sharing', '_blank')}
