...
Passionate about mastering data structures and algorithms, with a strong focus on problem-solving and competitive programming. Adept at designing efficient algorithms and optimizing code for performance. Experienced in tackling complex computational challenges and participating in coding contests. Committed to continuous learning, exploring advanced algorithms, and refining problem-solving techniques. Aspiring to leverage algorithmic expertise in real-world applications, software development, and AI-driven solutions.
              </p>
            </div>
          </div>
        </div>
      ...
      <section className="py-16 px-6 bg-white">
        <div className="max-w-6xl mx-auto text-center">
          ...
          <div className="flex flex-wrap justify-center gap-8">
            <a href="mailto:22csec20@gmail.com" className="flex items-center gap-3 text-gray-700 hover:text-blue-600 transition-colors">
              <Mail className="w-6 h-6" />
              <span>22csec20@gmail.com</span>
            </a>
            <a href="tel:6382493509" className="flex items-center gap-3 text-gray-700 hover:text-blue-600 transition-colors">
              <Phone className="w-6 h-6" />
              <span>6382493509</span>
            </a>
            <a href='https://www.linkedin.com/in/roshinisj15/' target="_blank" rel="noopener noreferrer" className="flex items-center gap-3 text-gray-700 hover:text-blue-600 transition-colors">
          ...
          <div className="mt-12">
            <button 
              onClick={() => window.open('https://drive.google.com/file/d/1_bmYrc6O7h1vH-RF44YNpuduNaYKq1Mc/view?usp=sharing', '_blank')}
