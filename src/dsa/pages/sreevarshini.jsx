...
const Sreevarshini = () => {
  ...
  const experiences = [
    {
      company: "Exposys Data Labs, Bangalore – Online",
      role: " Web Development",
      duration: "DEC 2023 - JAN 2024",
      responsibilities: [
        "Completed a 1-month online internship focused HTML,CSS and JSwhere I build a web page providing beauty tips."
      ]
    },
    {
      company: " Pydun Innovative technology,Madurai– Offline",
      role: " Backend Development",
      duration: "01.07.2024 to 30.07.2024",
      responsibilities: [
       'Completed a 1-month internship as a backend developer, where I worked with the Laravel framework to develop and optimize backend functionalities for web applications.',
      ]
        ...
        <div className="max-w-6xl mx-auto px-6">
          <div className="flex flex-col md:flex-row items-center gap-12">
            ...
            <div className="text-center md:text-left">
              ...
              To leverage my skills, knowledge, and passion for web development in a challenging professional environment 
that fosters growth and innovation, while contributing meaningfully to the success of the organization through the 
creation of user-friendly, responsive, and secure web applications
              </p>
            </div>
          </div>
        </div>
      ...
      <section className="py-16 px-6 bg-white">
        <div className="max-w-6xl mx-auto text-center">
          ...
          <div className="flex flex-wrap justify-center gap-8">
            <a href="mailto:shreevarshinir@gmail.com" className="flex items-center gap-3 text-gray-700 hover:text-blue-600 transition-colors">
              <Mail className="w-6 h-6" />
              <span>shreevarshinir@gmail.com</span>
            </a>
            <a href="tel:8220510274" className="flex items-center gap-3 text-gray-700 hover:text-blue-600 transition-colors">
              <Phone className="w-6 h-6" />
              <span>8220510274</span>
            </a>
            <a href=' www.linkedin.com/in/shreevarshini-ramesh-332426291' target="_blank" rel="noopener noreferrer" className="flex items-center gap-3 text-gray-700 hover:text-blue-600 transition-colors">
