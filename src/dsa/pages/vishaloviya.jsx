...
const VishalOviya = () => {
  ...
  const experiences = [
    ...
    {
      company: "TRINGAPPS ,CHENNAI (INTERN)",
  ...
  const skills = [
    "React", "Node.js", "C", "JAVA", 
    "HTML-CSS", "NETWORKING", "SQL"
  ];
      ...
      <section className="py-16 px-6 bg-white">
        <div className="max-w-6xl mx-auto text-center">
          ...
          <div className="flex flex-wrap justify-center gap-8">
            <a href="mailto:22csec32@gmail.com" className="flex items-center gap-3 text-gray-700 hover:text-blue-600 transition-colors">
              <Mail className="w-6 h-6" />
              <span>22csec32@gmail.com</span>
            </a>
            <a href="tel:9080863221" className="flex items-center gap-3 text-gray-700 hover:text-blue-600 transition-colors">
              <Phone className="w-6 h-6" />
              <span>9080863221</span>
            </a>
            <a href='https://www.linkedin.com/in/vishal-oviya-s-5a6633269/' target="_blank" rel="noopener noreferrer" className="flex items-center gap-3 text-gray-700 hover:text-blue-600 transition-colors">
          ...
          <div className="mt-12">
            <button 
              onClick={() => window.open('https://drive.google.com/file/d/1aRrwm3RQfoymbnoh-LIImOBbilEIbz0m/view?usp=sharing', '_blank')}
