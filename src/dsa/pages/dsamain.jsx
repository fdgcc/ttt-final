...
import jeyabharathipic from '../images/JAYABHARATHI P.JPG';
import preethipic from '../images/PREETHI S.JPG';
import shabarrishpic from '../images/ShabarrishP.jpg';
import vishaloviyapic from '../images/VISHAL OVIYA S.JPG';
import sreevarshinipic from '../images/sreevarshini.jpg';
...
const Dsa= () => {
  ...
  const trainers = [
    { 
      url: '/Sabreen',
      img: sabreenpic,  // Using the imported image
      name: 'SABREEN MARYAM M',
      role: 'GEN AI',
      expertise: ['GEN AI','DSA', 'FULLSTACK', 'OOPS','JAVA'],
      
    },
    {
        url: '/roshini',
        img:roshinipic ,  // Using the imported image
        name: 'ROSHINI JS',
        role: 'GEN AI',
        expertise: ['GEN AI','DSA', 'FULLSTACK', 'OOPS','JAVA'],
    ...
    {
        url: '/muthiswari',
        img: Muthispic,  // Using the imported image
        name: 'MUTHIESWARI S',
        role: 'GEN AI',
        expertise: ['GEN AI','DSA', 'FULLSTACK', 'OOPS','JAVA'],
     ...
     { 
      url: '/naveenkumark',
      img: naveenkpic,  // Using the imported image
      name: 'NAVEEN KUMAR K',
        role: 'GEN AI',
      expertise: ['GEN AI','DSA', 'FULLSTACK', 'OOPS','JAVA'],
    ...
    { 
      url: '/shabarrish',
      img: shabarrishpic,  // Using the imported image
      name: ' SHABARRISH P',
      role: 'GEN AI',
      expertise: ['GEN AI','DSA', 'FULLSTACK', 'AWS','JAVA'],
      
    },
    { 
      url: '/shuruthika',
      img: shuruthikapic,  // Using the imported image
      name: 'SHURUTHIKA S',
      role: 'GEN AI',
      expertise: ['GEN AI','DSA', 'FULLSTACK', 'OOPS','JAVA'],
    ...
    { 
      url: '/rooba',
      img: roobapic,  // Using the imported image
      name: ' ROOBA LAKSHMI NB',
      role: 'GEN AI',
      expertise: ['GEN AI','DSA', 'FULLSTACK', 'AWS','JAVA'],
    ...
    { 
      url: '/jayabharathi',
      img: jeyabharathipic,  // Using the imported image
      name: 'JAYABHARATHI',
      role: 'GEN AI',
      expertise: ['GEN AI','DSA', 'FULLSTACK', 'AWS','JAVA'],
    ...
    { 
      url: '/preethi',
      img: preethipic,  // Using the imported image
      name: 'PREETHI',
      role: 'GEN AI',
      expertise: ['GEN AI','DSA', 'FULLSTACK', 'AWS','JAVA'],
    ...
    { 
      url: '/vishaloviya',
      img: vishaloviyapic,  // Using the imported image
      name: 'VISHAL OVIYA',
      role: 'GEN AI',
      expertise: ['GEN AI','DSA', 'FULLSTACK', 'AWS','JAVA'],
    ...
    { 
      url: '/sreevarshini',
      img: sreevarshinipic,  // Using the imported image
      name: 'SREE VARSHINI',
      role: 'GEN AI',
      expertise: ['GEN AI','DSA', 'FULLSTACK', 'AWS','JAVA'],
        ...
        <div className="container mx-auto px-6 relative z-10">
          <div className="flex flex-col items-center text-center">
            ...
            <p className="text-xl md:text-2xl text-blue-700 mb-12 max-w-2xl leading-relaxed">
              Master the GEN-AI with our Trainers
            </p>

            <div className="flex flex-wrap gap-6 justify-center">
              <button className="px-8 py-4 bg-gradient-to-r from-blue-500 to-blue-700 rounded-full font-semibold text-white hover:from-blue-600 hover:to-blue-800 transition-all hover:scale-105 active:scale-95 shadow-lg shadow-blue-200" onClick={()=>navigate('/DSAgmeet')}>
                Start Your Journey
              </button>
              <a href="https://drive.google.com/file/d/16UME3TmQGSm3y6xHx645iEipOex1mKNj/view?usp=sharing">
      ...
      <section className="py-20 px-6 bg-gray-100 relative overflow-hidden">
          <div className="max-w-4xl mx-auto relative z-10">
            <div className="text-center">
              ...
              <a
                href="https://drive.google.com/drive/folders/1FAw_jzFYQ2SH8Qsnk0Wu123jw3UJRzsK"
                target="_blank"
