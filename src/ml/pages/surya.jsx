...
import suryapic from '../images/SURYA B S.JPG';
...
const Surya= () => {
  ...
  const experiences = [
    {
      company: " DCI, Madurai",
      role: "Computer Vision Developer - DCI, Madurai",
    ...
    },
    {
      ...
      responsibilities: ['Hugging Face | Stable Diffusion | 2d-3d point clouds'
      ]
        ...
        <div className="max-w-6xl mx-auto px-6">
          <div className="flex flex-col md:flex-row items-center gap-12">
            ...
            <div className="text-center md:text-left">
              ...
              <h2 className="text-2xl text-blue-600 mb-4">ML TRAINER</h2>
              <p className="text-xl text-gray-700 max-w-2xl">
              EXPERTISE IN - MACHINE LEARNING & COMPUTER VISION.
              </p>
            </div>
          </div>
        </div>
      ...
      <section className="py-16 px-6 bg-white">
        <div className="max-w-6xl mx-auto text-center">
          ...
          <div className="flex flex-wrap justify-center gap-8">
            <a href="mailto:surya.bs.innovates@gmail.com" className="flex items-center gap-3 text-gray-700 hover:text-blue-600 transition-colors">
              <Mail className="w-6 h-6" />
              <span>surya.bs.innovates@gmail.com</span>
            </a>
            <a href="tel:9360477515" className="flex items-center gap-3 text-gray-700 hover:text-blue-600 transition-colors">
              <Phone className="w-6 h-6" />
              <span>9360477515</span>
            </a>
            <a href="https://www.linkedin.com/in/surya-b-s-64aa4b241/i" target="_blank" rel="noopener noreferrer" className="flex items-center gap-3 text-gray-700 hover:text-blue-600 transition-colors">
          ...
          <div className="mt-12">
            <button 
              onClick={() => window.open('https://drive.google.com/file/d/1DJz6u8BbqERdUoklyBio82nwXJLmW3L5/view?usp=sharing', '_blank')}
