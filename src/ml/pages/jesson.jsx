...
const Jesson= () => {
  ...
  const experiences = [
    {
      company: " DCI, Madurai",
      role: "Computer Vision Developer -r",
    ...
    },
    {
      ...
      responsibilities: ['Designed a completely working website using php, HTML and other tools.'
      ]
      ...
      <section className="py-16 px-6 bg-white">
        <div className="max-w-6xl mx-auto text-center">
          ...
          <div className="flex flex-wrap justify-center gap-8">
            <a href="mailto:jessondaniel.j@gmail.com" className="flex items-center gap-3 text-gray-700 hover:text-blue-600 transition-colors">
              <Mail className="w-6 h-6" />
              <span>jessondaniel.j@gmail.com</span>
            </a>
            <a href="tel:9442771742" className="flex items-center gap-3 text-gray-700 hover:text-blue-600 transition-colors">
              <Phone className="w-6 h-6" />
              <span>9442771742</span>
            </a>
            <a href="https://www.linkedin.com/in/jesson-daniel-70a051339/" target="_blank" rel="noopener noreferrer" className="flex items-center gap-3 text-gray-700 hover:text-blue-600 transition-colors">
          ...
          <div className="mt-12">
            <button 
              onClick={() => window.open('https://drive.google.com/drive/folders/1YdQbTMPalV-o8jpH-zTzALMgaZdlQWh-', '_blank')}
