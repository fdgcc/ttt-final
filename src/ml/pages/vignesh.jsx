...
import vigneshpic from '../images/Vignesh Babu.jpg';
...
const Vignesh= () => {
  ...
  const experiences = [
    {
      company: "Computer Vision Developer - DCI, Madurai",
      role: "CV Developer",
      duration: "AUG 2024 - NOV 2024",
      responsibilities: [
        " Developed a Realtime Application for Monitoring and Analyzing Suspicious Activities in a CCTV."
      ]
    },
    {
      company: "- THE SPARKS FOUNDATION",
      role: "Full Stack Developer",
      duration: "JUNE 2024 - JUNLY 2024",
  ...
  const skills = [
  "Python","MERN", "deep learning", "Express", 
    "UI/UX", "POWERBI", "PHP"
  ];
        ...
        <div className="max-w-6xl mx-auto px-6">
          <div className="flex flex-col md:flex-row items-center gap-12">
            ...
            <div className="text-center md:text-left">
              ...
              <h2 className="text-2xl text-blue-600 mb-4"> Machine learning Developer Trainer</h2>
              <p className="text-xl text-gray-700 max-w-2xl">
              An enthusiastic AI and Machine Learning developer with expertise in few-shot learning, deep
              learning, and computer vision. Seeking to solve complex challenges in cutting-edge ML projects.
              </p>
            </div>
          </div>
        </div>
      ...
      <section className="py-16 px-6 bg-white">
        <div className="max-w-6xl mx-auto text-center">
          ...
          <div className="flex flex-wrap justify-center gap-8">
            <a href="mailto:t.r.vigneshbabu3110@gmail.com" className="flex items-center gap-3 text-gray-700 hover:text-blue-600 transition-colors">
              <Mail className="w-6 h-6" />
              <span>t.r.vigneshbabu3110@gmail.com</span>
            </a>
            <a href="tel:+91 6381775957" className="flex items-center gap-3 text-gray-700 hover:text-blue-600 transition-colors">
              <Phone className="w-6 h-6" />
              <span>+91 6381775957</span>
            </a>
            <a href="https://www.linkedin.com/in/vignesh-babu-t-r-880880250/" target="_blank" rel="noopener noreferrer" className="flex items-center gap-3 text-gray-700 hover:text-blue-600 transition-colors">
          ...
          <div className="mt-12">
            <button 
              onClick={() => window.open('https://drive.google.com/file/d/1r8078qPfzdMHPXSuZPAYHF5qzof5Uiyy/view?usp=sharing', '_blank')}
