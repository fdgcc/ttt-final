...
const Mohamedshihab = () => {
  ...
  const experiences = [
    {
      company: "NSIC - Technical Services ",
      role: "App Developer",
    ...
    {
      company: "Futuric tech private limited",
    ...
    {
      company: "Quantanic Techserv private limited",
      role: "IOT INTERNt",
      duration: "15days jan 2023",
      responsibilities: [
        'Arudino app, C++',
      ]
        ...
        <div className="max-w-6xl mx-auto px-6">
          <div className="flex flex-col md:flex-row items-center gap-12">
            ...
            <div className="text-center md:text-left">
              ...
              Ambitious Computer Science and Engineering student with expertise in full-stack development and a keen enthusiasm for AR/VR development. Aiming to utilize strong technical skills and creative problem-solving to drive impactful software solutions in a collaborative environment.
              </p>
            </div>
          </div>
        </div>
      ...
      <section className="py-16 px-6 bg-white">
        <div className="max-w-6xl mx-auto text-center">
          ...
          <div className="flex flex-wrap justify-center gap-8">
            <a href="mailto:Mohamedshihab1989812@gmail.com" className="flex items-center gap-3 text-gray-700 hover:text-blue-600 transition-colors">
              <Mail className="w-6 h-6" />
              <span>Mohamedshihab1989812@gmail.com</span>
            </a>
            <a href="tel:+91 8681803389" className="flex items-center gap-3 text-gray-700 hover:text-blue-600 transition-colors">
              <Phone className="w-6 h-6" />
              <span>+91 8681803389</span>
            </a>
            <a href='https://www.linkedin.com/in/mohamed-shihab-354228264/' target="_blank" rel="noopener noreferrer" className="flex items-center gap-3 text-gray-700 hover:text-blue-600 transition-colors">
          ...
          <div className="mt-12">
            <button 
              onClick={() => window.open('https://drive.google.com/file/d/1GglORNbLtrgUdksCelDONPOF0EaXhtoL/view?usp=sharing', '_blank')}
