...
const ArVr= () => {
  ...
  const trainers = [
    { 
      url: '/santhosh',
      img: santhoshmrspic,  // Using the imported image
      name: ' SANTHOSH M R S',
      role: 'AR-VR',
      expertise: ["Python", "Js", "C", "C#", "Solidity", ],
      
    },
    {
        url: '/mohamedshihab',
        img: shihabpic,  // Using the imported image
        name: ' MOHAMED SHIHAB S',
        role: 'AR-VR',
        expertise: ["unity", "blender", 
          "VR", "NETWORKING", "SQL"],
        ...
        <div className="container mx-auto px-6 relative z-10">
          ...
          <div className="relative w-full h-24 mb-8">
            ...
            <div className="relative transform transition-all duration-500 hover:scale-105">
              ...
              {/* Removed Sparkles icon from here */}
            ...
            <p className="text-xl md:text-2xl text-blue-700 mb-12 max-w-2xl leading-relaxed">
              Master the AR-VR with our expert Trainers and cutting-edge curriculum
            </p>

            <div className="flex flex-wrap gap-6 justify-center">
              <button className="px-8 py-4 bg-gradient-to-r from-blue-500 to-blue-700 rounded-full font-semibold text-white hover:from-blue-600 hover:to-blue-800 transition-all hover:scale-105 active:scale-95 shadow-lg shadow-blue-200" onClick={()=>navigate('/ARVRgmeet')}>
                Start Your Journey
              </button>
