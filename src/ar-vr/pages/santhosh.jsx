...
const Santhoshmrs = () => {
  ...
  const experiences = [
    {
      company: "ABRAHAM HEALTH CARE , Madurai",
      role: "WEB DESIGNING",
      duration: "Aug to Sep ,2024 (1 month)",
      responsibilities: [
    'Web Designing, Full Stack Development, API Integration'
      ]
    },
    {
      company: "DevDen -Metaverse Creators , Bangalore",
      role: "AR/VR/XR Intern",
      duration: "Jul to Aug ,2024 (1 month)",
      responsibilities: [
        "AR VR XR toolkits and frameworks,Unity3D Engine"
      ]
        
    },
    {
      company: "AAKRO Development , Chennai",
      role: "Game Developer Intern & Python Developer",
      duration: "May to Sep ,2023 (5 month) & Jan to Mar ,2024 (3 month)",
      responsibilities: [
        "Unity3D Engine , C# Scripting",
        'Blockchain and AI Intern'
      ]
  ...
  const skills = [
    "Python", "Js", "C,C#", "Solidity", 
    "Postman API", "UNITY", "SQL"
  ];
        ...
        <div className="max-w-6xl mx-auto px-6">
          <div className="flex flex-col md:flex-row items-center gap-12">
            ...
            <div className="text-center md:text-left">
              ...
              <h2 className="text-2xl text-blue-600 mb-4">AR VR TRAINER</h2>
              <p className="text-xl text-gray-700 max-w-2xl">
                A R V R X R AND A I DEVELOPER
              </p>
            </div>
          </div>
        </div>
      ...
      <section className="py-16 px-6 bg-white">
        <div className="max-w-6xl mx-auto text-center">
          ...
          <div className="flex flex-wrap justify-center gap-8">
            <a href="mailto:passionateartist2004@gmail.com" className="flex items-center gap-3 text-gray-700 hover:text-blue-600 transition-colors">
              <Mail className="w-6 h-6" />
              <span>passionateartist2004@gmail.com</span>
            </a>
            <a href="tel:8778694542" className="flex items-center gap-3 text-gray-700 hover:text-blue-600 transition-colors">
              <Phone className="w-6 h-6" />
              <span>8778694542</span>
            </a>
            <a href='https://www.linkedin.com/in/santhosh00700/' target="_blank" rel="noopener noreferrer" className="flex items-center gap-3 text-gray-700 hover:text-blue-600 transition-colors">
          ...
          <div className="mt-12">
            <button 
              onClick={() => window.open('https://drive.google.com/file/d/1UdiGDGwHapVmJ7yXAMjwiWmum0Ji9D4n/view?usp=sharing', '_blank')}
