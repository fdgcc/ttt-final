...
const Meerashafrin = () => {
  ...
  const experiences = [
    {
      company: "SVASTI TECH SOLUTIONS,TRICHY ",
      role: "Backend Developer",
      duration: "22.12.2023 to 05.01.2024.",
      responsibilities: [
        'Gained exposure to practical knowledge and had a hands on experience in Web Development and Figma.'
      ]
    },
    {
      ...
      <section className="py-16 px-6 bg-white">
        <div className="max-w-6xl mx-auto text-center">
          ...
          <div className="flex flex-wrap justify-center gap-8">
            <a href="mailto:22csec14@gmail.com" className="flex items-center gap-3 text-gray-700 hover:text-blue-600 transition-colors">
              <Mail className="w-6 h-6" />
              <span>22csec14@gmail.com</span>
            </a>
            <a href="tel:9597400471" className="flex items-center gap-3 text-gray-700 hover:text-blue-600 transition-colors">
              <Phone className="w-6 h-6" />
              <span>9597400471</span>
            </a>
            <a href='https://www.linkedin.com/in/meera-shafrin-514260291/' target="_blank" rel="noopener noreferrer" className="flex items-center gap-3 text-gray-700 hover:text-blue-600 transition-colors">
          ...
          <div className="mt-12">
            <button 
              onClick={() => window.open('https://drive.google.com/file/d/15uuT5rGKs6ZgkOzB7tc8LKPaA__TWPXq/view?usp=sharing', '_blank')}
