  ...
  const experiences = [
    {
      ...
      },
      {
        ...
        responsibilities: [
         'I have learned the basics of game development' ,
         'I have learned to use the Unity',
         'I have developed a small Survival game',
        ]
      ...
      <section className="py-16 px-6 bg-white">
        <div className="max-w-6xl mx-auto text-center">
          ...
          <div className="flex flex-wrap justify-center gap-8">
            <a href="mailto:snaganimesh2004@gmail.com" className="flex items-center gap-3 text-gray-700 hover:text-blue-600 transition-colors">
              <Mail className="w-6 h-6" />
              <span>snaganimesh2004@gmail.com</span>
            </a>
            <a href="tel:96555706988" className="flex items-center gap-3 text-gray-700 hover:text-blue-600 transition-colors">
              <Phone className="w-6 h-6" />
              <span>96555706988</span>
            </a>
            <a href='https://www.linkedin.com/in/naganimesh-s/' target="_blank" rel="noopener noreferrer" className="flex items-center gap-3 text-gray-700 hover:text-blue-600 transition-colors">
          ...
          <div className="mt-12">
            <button 
              onClick={() => window.open('https://drive.google.com/file/d/1mieE3EtQ9NFc0FB-PpmzO9MoW8Eq8uw0/view?usp=sharing', '_blank')}
