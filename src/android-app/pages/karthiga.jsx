        ...
        <div className="max-w-6xl mx-auto text-center">
          ...
          <div className="flex flex-wrap justify-center gap-8">
            ...
            <a href="tel:7010509807" className="flex items-center gap-3 text-gray-700 hover:text-blue-600 transition-colors">
              ...
              <span>7010509807</span>
            </a>
            <a href='https://www.linkedin.com/in/karthiga-m-8a1216291' target="_blank" rel="noopener noreferrer" className="flex items-center gap-3 text-gray-700 hover:text-blue-600 transition-colors">
          ...
          <div className="mt-12">
            <button 
              onClick={() => window.open('/https://drive.google.com/file/d/15vwFHQTe4EGhQq7_AyqvXrx8ByLUGuUd/view?usp=sharing', '_blank')}
